...
卖出属于投资行动，必须执行完整 DD Pipeline；见 [prompts/dd_pipeline.md](../prompts/dd_pipeline.md)。DD 深度见 [OPERATIONS.md](../OPERATIONS.md)「DD 深度分级」：**卖出始终走完整八步**。
...
4. 按 [DD Pipeline](../prompts/dd_pipeline.md) 完整八步执行；各步细则见对应 `skills/*/SKILL.md`。
